---
layout:     post
title:      MS Teams 日常管理系列1：Teams PowerShell 命令详解
subtitle:  xxx
date:       2020-5-20
author:  Nemo
...
微软在5月1号发布了针对Teams 团队应用管理的命令模块：Microsoft Teams - PowerShell Module ，它可以让IT管理员针对Teams中的团队应用进行管理，也只针对团队应用而已，即如下应用:
...
1)  IT管理员就可以帮助大量业务用户快速生成/删除所需的团队了（即团队的生命周期管理），同时应用到OA系统进行Teams团队的自动化管理了；
...
![MS Teams 日常管理系列1：Teams PowerShell 命令详解]()
...
创建出来的团队应用之后，我们还可以通过Set-Team来修改各种设置（也许这就是上文没有把Team Setting单独列出的原因，整合在这里面了）
...
以下Roadmap供参考：
![MS Teams 日常管理系列1：Teams PowerShell 命令详解](C:\Users\Nemo\Documents\GitHub\tangx007\img\r-14f3cfff05d77cf57be0513a2876faa4a0.png)
